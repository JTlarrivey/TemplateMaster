...
if (document.getElementById('basic-area-chart')) {
  fetch('http://localhost/orquestadorLiit/apiProxy.php?type=metrics&target=metrics')
    ...
    .then(data => {
      const basicAreaOptions = {
        ...
        colors: [
          ...
          window.colorMap.success[500].hex  // una segunda serie con color distinto
        ],
        fill: {
          type: 'gradient',
          gradient: {
  ...
  if (document.getElementById('spline-area-chart')) {
    fetch('http://localhost/orquestadorLiit/apiProxy.php?type=dashboard_db&target=spline')
    ...
    const splineAreaChart = new ApexCharts(document.getElementById('spline-area-chart'), splineAreaOptions);
  ...
  if (document.getElementById('negative-area-chart')) {
    ...
    const negativeAreaChart = new ApexCharts(document.getElementById('negative-area-chart'), negativeAreaOptions);
  ...
  if (document.getElementById('github-area-chart')) {
    ...
    const githubdata = {
      series: [{
        x: new Date("2016-03-01").getTime(),
        y: 2
      }, {
        x: new Date("2016-04-01").getTime(),
        y: 8
      }, {
        x: new Date("2016-05-01").getTime(),
        y: 0
      }, {
        x: new Date("2016-06-01").getTime(),
        y: 2
      }, {
        x: new Date("2016-07-01").getTime(),
        y: 15
      }, {
        x: new Date("2016-08-01").getTime(),
        y: 0
      }, {
        x: new Date("2016-09-01").getTime(),
        y: 0
      }, {
        x: new Date("2016-10-01").getTime(),
        y: 0
      }, {
        x: new Date("2016-11-01").getTime(),
        y: 0
      }, {
        x: new Date("2016-12-01").getTime(),
        y: 0
      }, {
        ...
        x: new Date("2017-03-01").getTime(),
        y: 0
      }, {
        x: new Date("2017-04-01").getTime(),
        y: 0
      }, {
        x: new Date("2017-05-01").getTime(),
        y: 10
      }, {
        x: new Date("2017-06-01").getTime(),
        y: 0
      }, {
        x: new Date("2017-07-01").getTime(),
        y: 12
      }, {
        x: new Date("2017-08-01").getTime(),
        y: 2
      }, {
        x: new Date("2017-09-01").getTime(),
        y: 0
      }, {
        x: new Date("2017-10-01").getTime(),
        y: 0
      }, {
        x: new Date("2017-11-01").getTime(),
        y: 0
      }, {
        x: new Date("2017-12-01").getTime(),
        y: 0
      }, {
        ...
        x: new Date("2018-08-01").getTime(),
        y: 0
      }, {
        x: new Date("2018-09-01").getTime(),
        y: 10
      }, {
        x: new Date("2018-10-01").getTime(),
        y: 0
      }, {
        x: new Date("2018-11-01").getTime(),
        y: 0
      }, {
        x: new Date("2018-12-01").getTime(),
        y: 0
      }, {
    ...
    const mainChart = new ApexCharts(document.getElementById('github-area-chart'), mainChartOptions);
    mainChart.render();

    // Create the brush chart
    const brushChart = new ApexCharts(document.getElementById('github-area-chart-brush'), brushChartOptions);
    brushChart.render();
  }
  ...
  if (document.getElementById('stacked-area-chart')) {
    ...
    const stackedAreaChart = new ApexCharts(document.getElementById('stacked-area-chart'), stackedAreaOptions);
  ...
  if (document.getElementById('irregular-area-chart')) {
    const irregularAreaOptions = {
      series: [{
        name: 'Network',
        data: [{
          x: new Date('Dec 23 2017').getTime(),
          y: 0
        }, {
          x: new Date('Dec 24 2017').getTime(),
          y: 44
        }, {
          x: new Date('Dec 25 2017').getTime(),
          y: 31
        }, {
          x: new Date('Dec 26 2017').getTime(),
          y: 38
        }, {
          x: new Date('Dec 27 2017').getTime(),
          y: null
        }, {
          x: new Date('Dec 28 2017').getTime(),
          y: 32
        }, {
          x: new Date('Dec 29 2017').getTime(),
          y: 55
        }, {
          x: new Date('Dec 30 2017').getTime(),
          y: 51
        }, {
          x: new Date('Dec 31 2017').getTime(),
          y: 67
        }, {
          x: new Date('Jan 01 2018').getTime(),
          y: 22
        }, {
          x: new Date('Jan 02 2018').getTime(),
          y: 34
        }, {
          x: new Date('Jan 03 2018').getTime(),
          y: null
        }, {
          x: new Date('Jan 04 2018').getTime(),
          y: null
        }, {
          x: new Date('Jan 05 2018').getTime(),
          y: 11
        }, {
          x: new Date('Jan 06 2018').getTime(),
          y: 4
        }, {
          x: new Date('Jan 07 2018').getTime(),
          y: 15
        }, {
          x: new Date('Jan 08 2018').getTime(),
          y: null
        }, {
          x: new Date('Jan 09 2018').getTime(),
          y: 9
        }, {
          x: new Date('Jan 10 2018').getTime(),
          y: 34
        }, {
          x: new Date('Jan 11 2018').getTime(),
          y: null
        }, {
          x: new Date('Jan 12 2018').getTime(),
          y: null
        }, {
          x: new Date('Jan 13 2018').getTime(),
          y: 13
        }, {
          x: new Date('Jan 14 2018').getTime(),
          y: null
        }]
      }],
      chart: {
    ...
    const irregularAreaChart = new ApexCharts(document.getElementById('irregular-area-chart'), irregularAreaOptions);
  ...
  if (document.getElementById('null-values-area-chart')) {
    ...
    const nullValuesAreaChart = new ApexCharts(document.getElementById('null-values-area-chart'), nullValuesAreaOptions);

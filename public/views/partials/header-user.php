    <header class="app-header">
        ...
        <div class="d-flex flex-grow-1 w-100 me-auto align-items-center">
            ...
            <div class="mobile-menu-icon me-2 d-flex d-sm-flex d-md-flex d-lg-none flex-shrink-0" data-action="toggle-swap" data-toggleclass="app-mobile-menu-open" aria-label="Toggle Mobile Menu">
                <svg class="sa-icon">
                    <use href="/converseLarry/public/assets/img/sprite.svg#menu"></use>
                </svg>
            </div>
            <!-- Collapse icon -->
        ...
        <!--button type="button" class="btn btn-system d-none d-sm-block d-sm-none d-md-none d-lg-block" data-action="toggle-swap" data-toggleclass="open" data-target="aside.js-app-drawer" aria-label="Open Sidebar">
            <svg class="sa-icon sa-icon-2x">
                <use href="/converseLarry/public/assets/img/sprite.svg#monitor"></use>
            </svg>
        </button-->
        ...
        <!--button type="button" class="btn btn-system dropdown-toggle no-arrow" data-bs-toggle="dropdown" aria-expanded="false" aria-label="Open Notifications">
            ...
            <svg class="sa-icon sa-icon-2x">
                <use href="/converseLarry/public/assets/img/sprite.svg#bell"></use>
            </svg>
        </button-->
            ...
            <div class="tab-content tab-notification">
                    ...
                    <div class="d-flex h-100">
                        <div class="px-4 d-flex flex-column align-items-center justify-content-center">
                            <svg class="sa-icon sa-icon-5x sa-icon-primary">
                                <use href="/converseLarry/public/assets/img/sprite.svg#arrow-up-circle"></use>
                            </svg>
                    ...
                    <div class="custom-scroll h-100">
                        <ul class="notification">
                            <li class="unread alert alert-dismissable">
                                <div class="d-flex align-items-center">
                                    <span class="status me-2">
                                        <span class="profile-image rounded-circle d-inline-block" style="background-image:url('/converseLarry/public/assets/img/avatar-c.png')"></span>
                                    </span>
                            ...
                            <li class="unread alert alert-dismissable">
                                <div class="d-flex align-items-center">
                                    <span class="status me-2">
                                        <span class="profile-image rounded-circle d-inline-block" style="background-image:url('/converseLarry/public/assets/img/avatar-a.png')"></span>
                                    </span>
                                    <span class="d-flex flex-column flex-1 ms-1">
                            ...
                            <li class="alert alert-dismissable">
                                <div class="d-flex align-items-center">
                                    <span class="status status-success me-2">
                                        <span class="profile-image rounded-circle d-inline-block" style="background-image:url('/converseLarry/public/assets/img/avatar-b.png')"></span>
                                    </span>
                                    <span class="d-flex flex-column flex-1 ms-1">
                            ...
                            <li class="alert alert-dismissable">
                                <div class="d-flex align-items-center">
                                    <span class="status status-warning me-2">
                                        <span class="profile-image rounded-circle d-inline-block" style="background-image:url('/converseLarry/public/assets/img/avatar-e.png')"></span>
                                    </span>
                                    <span class="d-flex flex-column flex-1 ms-1">
                            ...
                            <li class="alert alert-dismissable">
                                <div class="d-flex align-items-center">
                                    <span class="status status-success me-2">
                                        <span class="profile-image rounded-circle d-inline-block" style="background-image:url('/converseLarry/public/assets/img/avatar-h.png')"></span>
                                    </span>
                                    <span class="d-flex flex-column flex-1 ms-1">
                            ...
                            <li class="alert alert-dismissable">
                                <div class="d-flex align-items-center">
                                    <span class="status status-success me-2">
                                        <span class="profile-image rounded-circle d-inline-block" style="background-image:url('/converseLarry/public/assets/img/avatar-m.png')"></span>
                                    </span>
                                    <span class="d-flex flex-column flex-1 ms-1">
                            ...
                            <li class="alert alert-dismissable">
                                <div class="d-flex align-items-center">
                                    <span class="status status-danger me-2">
                                        <span class="profile-image rounded-circle d-inline-block" style="background-image:url('/converseLarry/public/assets/img/avatar-j.png')"></span>
                                    </span>
                                    <span class="d-flex flex-column flex-1 ms-1">
                        ...
                        <div class="notification-empty-msg">
                            <svg class="sa-icon sa-icon-5x sa-icon-primary">
                                <use href="/converseLarry/public/assets/img/sprite.svg#coffee"></use>
                            </svg>
                ...
                <div class="tab-pane fade" id="tab-feeds" role="tabpanel">
                    <div class="custom-scroll h-100">
                                ...
                                <div class="d-flex align-items-center show-child-on-hover">
                                    <div class="d-flex flex-column flex-1">
                                        ...
                                        <div class="fs-sm d-flex align-items-center mt-2">
                                            <span class="profile-image-md ms-1 rounded-circle d-inline-block" style="background-image:url('/converseLarry/public/assets/img/avatar-a.png'); background-size: cover;"></span>
                                            <span class="profile-image-md ms-1 rounded-circle d-inline-block" style="background-image:url('/converseLarry/public/assets/img/avatar-b.png'); background-size: cover;"></span>
                                            <span class="profile-image-md ms-1 rounded-circle d-inline-block" style="background-image:url('/converseLarry/public/assets/img/avatar-c.png'); background-size: cover;"></span>
                                            <span class="profile-image-md ms-1 rounded-circle d-inline-block" style="background-image:url('/converseLarry/public/assets/img/avatar-e.png'); background-size: cover;"></span>
                                            <div data-hasmore="+3" class="rounded-circle profile-image-md ms-1">
                                                <span class="profile-image-md ms-1 rounded-circle d-inline-block" style="background-image:url('/converseLarry/public/assets/img/avatar-h.png'); background-size: cover;"></span>
                                            </div>
                                        </div>
                                    ...
                                    <div class="d-flex flex-column flex-1">
                                        ...
                                        <div class="fs-sm d-flex align-items-center mt-1">
                                            <a href="#" class="ms-1 mt-1" title="Cell A-0012">
                                                <span class="d-block img-share" style="background-image:url('/converseLarry/public/assets/img/pic-7.png'); background-size: cover;"></span>
                                            </a>
                                            <a href="#" class="ms-1 mt-1" title="Patient A-473 saliva">
                                                <span class="d-block img-share" style="background-image:url('/converseLarry/public/assets/img/pic-8.png'); background-size: cover;"></span>
                                            </a>
                                            <a href="#" class="ms-1 mt-1" title="Patient A-473 blood cells">
                                                <span class="d-block img-share" style="background-image:url('/converseLarry/public/assets/img/pic-11.png'); background-size: cover;"></span>
                                            </a>
                                            <a href="#" class="ms-1 mt-1" title="Patient A-473 Membrane O.C">
                                                <span class="d-block img-share" style="background-image:url('/converseLarry/public/assets/img/pic-12.png'); background-size: cover;"></span>
                                            </a>
                                        </div>
                                        <span class="fs-nano text-muted mt-1">55 minutes ago</span>
                                    </div>
                        ...
                        <div class="notification-empty-msg">
                            <svg class="sa-icon sa-icon-5x sa-icon-primary">
                                <use href="/converseLarry/public/assets/img/sprite.svg#smile"></use>
                            </svg>
                                ...
                                <tr>
                                    ...
                                    <td>
                                        <svg class="sa-icon sa-icon-warning m-1 position-absolute pos-left pos-top" style="--sa-icon-size: 0.85rem; --sa-fill-opacity: 0.5;">
                                            <use href="/converseLarry/public/assets/img/sprite.svg#star"></use>
                                        </svg> 6
                                    </td>
                                </tr>
                                <tr>
                                ...
                                <tr>
                                    ...
                                    <td>
                                        <svg class="sa-icon sa-icon-info m-1 position-absolute pos-left pos-top" style="--sa-icon-size: 0.85rem; --sa-fill-opacity: 0.5;">
                                            <use href="/converseLarry/public/assets/img/sprite.svg#shield"></use>
                                        </svg> 22
                                    </td>
                                    <td>23</td>
                                    <td>24</td>
